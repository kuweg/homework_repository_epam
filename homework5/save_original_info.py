...
До применения вашего декоратора
будет вызываться AttributeError при custom_sum.__original_func
...
def my_wraps(original_func):
    """My implementation of functools.wraps()."""
...
if __name__ == "__main__":
    ...
    print(str(custom_sum.__original_func))
